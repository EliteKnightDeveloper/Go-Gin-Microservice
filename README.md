...
```sh
$ git clone https://github.com/EliteKnightDeveloper/Go-Gin-Microservice.git
```
...
type User struct {
	...
	Name     string        `bson:"name" json:"name" example:"elite"`
	Password string        `bson:"password" json:"password" example:"elite"`
}
